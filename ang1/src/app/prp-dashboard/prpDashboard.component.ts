...
export class PrpDashboardComponent implements OnInit {
  ...
  onPrpDataGridReady(params) {
    ...
    this.prpDataColumns = [
      { field: 'tool',headerName:'Tool',width:'120px',cellClass:'ag-header-cell-content',pinned:'left'},
      { field: 'm101',headerName:'M101' ,sortable: false,width:'240px',cellClass:'ag-header-cell-content',pinned:'left',
       children:[
        { field: 'm101Wm',headerName:'Move' ,sortable: false,width:'90px',pinned:'left'},
        { field: 'm101Dft',headerName:'1C' ,sortable: false,width:'90px',cellClass:'ag-header-cell-content',pinned:'left'},
        { field: 'm101Prp',headerName:'10K' ,sortable: false,width:'90px',cellClass:'ag-header-cell-content',pinned:'left',
        cellStyle: params => {
          if (params.value >5) {
        ...
        { field: 'm102Scan',headerName:'Scan' ,sortable: true,width:'90px',cellClass:'ag-header-cell-content',pinned:'left',columnGroupShow: 'open'},
        { field: 'm102Hit',headerName:'Hit' ,sortable: true,width:'90px',cellClass:'ag-header-cell-content',pinned:'left',columnGroupShow: 'open'},
        { field: 'm102HitRate',headerName:'HitRate' ,sortable: true,width:'120px',cellClass:'ag-header-cell-content',pinned:'left',columnGroupShow: 'open'}
       ]
      },
      { field: 'm102',headerName:'M102' ,sortable: false,width:'240px',cellClass:'ag-header-cell-content',pinned:'left',
      children:[
       { field: 'm102Wm',headerName:'Move' ,sortable: false,width:'90px',pinned:'left'},
       { field: 'm102Dft',headerName:'1C' ,sortable: false,width:'90px',cellClass:'ag-header-cell-content',pinned:'left'},
       { field: 'm102Prp',headerName:'10K' ,sortable: false,width:'90px',cellClass:'ag-header-cell-content',pinned:'left',
       cellStyle: params => {
         if (params.value >5) {
             //mark police cells as red
             return {color: 'red'};
