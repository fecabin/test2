...
export class PrpDashboardComponent implements OnInit {
  ...
  onInspDataGridReady(params) {
    ...
    this.inspDataColumns = [
      { field: 'monthNo',headerName:'Month',sortable: true ,width:'100px',cellClass:'ag-header-cell-content',pinned:'left', cellStyle: {'text-align': 'center'}},
      { field: 'weekNo',headerName:'Week' ,sortable: true,width:'100px',cellClass:'ag-header-cell-content',pinned:'left', cellStyle: {'text-align': 'center'}},
      { field: 'maskId',headerName:'Mask' ,sortable: true,width:'160px',cellClass:'ag-header-cell-content',pinned:'left', cellStyle: {'text-align': 'center'}},

      { field: '',headerName:'Mask Inspection' ,sortable: true,width:180,cellClass:'ag-header-cell-content',
      children:[
        { field: 'inspDt' ,headerName:'Insp. Dt' ,sortable: true,width:'140px',cellClass:'ag-header-cell-content',pinned:'left'},
        { field: 'lastInspDt',headerName:'Last Insp. Dt' ,sortable: true,width:'140px',cellClass:'ag-header-cell-content',pinned:'left'}
      ]},
      ...
      { field: 'largeTool',headerName:'Prp Tool' ,sortable: true,width:'140px',cellClass:'ag-header-cell-content'},
